...
function init() {
  ...
  function anim () {
	...
	AtomTween.to (pixelSquare1, 		5, {delay:del+=0, left:800, top:120, ease:"ease-in-out"});
	AtomTween.to (pixelSquare2, 		5, {delay:del+=0, x:800, y:190, ease:"ease-in-out"});
	
	// AtomTween.to (pixelSquare2, 		GetRandom.number(2,8,true), {delay:del+=5, width:GetRandom.number(50,400,true), scale:GetRandom.number(1,4,true), rotate:GetRandom.number(50,400,true), ease:"ease-in-out"});
