...
function init() {
  ...
  function anim () {
	...
	AtomTween.to (idBanner, 			1, {delay:del+=1,  rotateY:180, rotateZ:60, ease:"ease-in-out"});	
	AtomTween.to (idCopy1, 			3, {delay:del+=0, rotateY:-180, ease:"ease-in-out"});

	AtomTween.to (idBanner, 			1, {delay:del+=1.5,  rotateY:0, ease:"ease-in-out"});	
